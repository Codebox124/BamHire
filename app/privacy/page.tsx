    ...
    return (
        <div className="bg-white text-[#4B5563] p-6 md:p-10 font-sans leading-relaxed">
                ...
                <section style={{ marginTop: '30px' }}>
                    <h2 className="text-2xl font-bold mb-4 text-[#8B654B]">1. Information We Collect</h2>
                ...
                <hr className="border-gray-700 my-6" />
                <section style={{ marginTop: '30px' }}>
                    <h2 className="text-2xl font-bold mb-4 text-[#8B654B]">2. How We Use Your Information</h2>
                    <ul style={{ paddingLeft: '20px', listStyleType: 'disc' }}>
                ...
                <hr className="border-gray-700 my-6" />
                <section style={{ marginTop: '30px' }}>
                    <h2 className="text-2xl font-bold mb-4 text-[#8B654B]">3. How We Share Your Information</h2>
                    <p>
                ...
                <hr className="border-gray-700 my-6" />
                <section style={{ marginTop: '30px' }}>
                    <h2 className="text-2xl font-bold mb-4 text-[#8B654B]">4. Your Choices and Rights</h2>
                    <ul style={{ paddingLeft: '20px', listStyleType: 'disc' }}>
                ...
                <hr className="border-gray-700 my-6" />
                <section style={{ marginTop: '30px' }}>
                    <h2 className="text-2xl font-bold mb-4 text-[#8B654B]">5. How We Protect Your Information</h2>
                    <p>
                ...
                <hr className="border-gray-700 my-6" />
                <section style={{ marginTop: '30px' }}>
                    <h2 className="text-2xl font-bold mb-4 text-[#8B654B]">6. Third-Party Links</h2>
                    <p>
                ...
                <hr className="border-gray-700 my-6" />
                <section style={{ marginTop: '30px' }}>
                    <h2 className="text-2xl font-bold mb-4 text-[#8B654B]">7. Children's Privacy</h2>
                    <p>
                ...
                <hr className="border-gray-700 my-6" />
                <section style={{ marginTop: '30px' }}>
                    <h2 className="text-2xl font-bold mb-4 text-[#8B654B]">8. Changes to This Policy</h2>
                    <p>
                ...
                <hr className="border-gray-700 my-6" />
                <section style={{ marginTop: '30px' }}>
                    <h2 className="text-2xl font-bold mb-4 text-[#8B654B]">9. Contact Us</h2>
