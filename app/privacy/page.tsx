...
export default function PrivacyPolicy() {
    return (
        <div className="bg-white text-[#4B5563] p-6 md:p-10 font-sans leading-relaxed">
            <h1 className="text-4xl font-extrabold mb-6  text-[#8B654B]">Privacy Policy</h1>
            <p className="mb-6">
            ...
            <section style={{ marginTop: '30px' }}>
                <h2 className="text-2xl font-bold mb-4 text-[#8B654B]"> Information We Collect</h2>
            ...
            <section style={{ marginTop: '30px' }}>
                <h2 className="text-2xl font-bold mb-4 text-[#8B654B]">How We Use Your Information</h2>
                <ul style={{ paddingLeft: '20px', listStyleType: 'disc' }}>
            ...
            <section style={{ marginTop: '30px' }}>
                <h2 className="text-2xl font-bold mb-4 text-[#8B654B]"> How We Share Your Information</h2>
                <p>
            ...
            <section style={{ marginTop: '30px' }}>
                <h2 className="text-2xl font-bold mb-4 text-[#8B654B]"> Your Choices and Rights</h2>
                <ul style={{ paddingLeft: '20px', listStyleType: 'disc' }}>
            ...
            <section style={{ marginTop: '30px' }}>
                <h2 className="text-2xl font-bold mb-4 text-[#8B654B]"> How We Protect Your Information</h2>
                <p>
            ...
            <section style={{ marginTop: '30px' }}>
                <h2 className="text-2xl font-bold mb-4 text-[#8B654B]"> Third-Party Links</h2>
                <p>
            ...
            <section style={{ marginTop: '30px' }}>
                <h2 className="text-2xl font-bold mb-4 text-[#8B654B]"> Children's Privacy</h2>
                <p>
            ...
            <section style={{ marginTop: '30px' }}>
                <h2 className="text-2xl font-bold mb-4 text-[#8B654B]"> Changes to This Policy</h2>
                <p>
            ...
            <section style={{ marginTop: '30px' }}>
                ...
                <address style={{ fontStyle: 'normal', marginTop: '10px' }}>
                    ...
                    Email: <a href="mailto:recruiting@BAM Hire.com" className='text-blue-600'>recruiting@BAM Hire.com</a>
                </address>
            </section>
